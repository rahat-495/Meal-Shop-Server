...
const orderMealSchema = new mongoose_1.Schema({
    email: { type: String, required: false },
    customer: { type: mongoose_1.Schema.Types.ObjectId, ref: 'user', required: true },
    id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'meal', required: true },
...
const orderMealModel = (0, mongoose_1.model)('orderMeal', orderMealSchema);
exports.default = orderMealModel;
